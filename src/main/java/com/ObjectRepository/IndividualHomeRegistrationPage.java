...
public class IndividualHomeRegistrationPage {
	//Declaration
		...
		public void RegisterHome(WebDriver driver,HashMap<String,String> map,JavaUtility jLib)
				{
		...
		String actual=ag.getKey();
			...
			{
				driver.findElement(By.id(ag.getKey())).sendKeys(ag.getValue()+jLib.randomNum());
			}
			...
			{
				driver.findElement(By.id(ag.getKey())).sendKeys("ag"+jLib.randomNum()+ag.getValue());
